...
public class Obj_classediagram {

	public static void main(String[] args) {
		Classe_diagrama cliente1 = new Classe_diagrama();//contrua para mim a partir da Classe Aviao. o objrto aviao 1
		Classe_diagrama cliente2 = new Classe_diagrama();
		//OBJETO 1
